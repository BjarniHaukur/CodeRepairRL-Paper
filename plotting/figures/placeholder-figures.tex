...
\begin{figure}[h]
	...
	\fbox{\begin{minipage}{0.8\textwidth}
			...
			\vspace{3cm}
		\end{minipage}}
	\caption{Complete system architecture illustrating data flow between the vLLM inference cluster, distributed agent worker pool, and GRPO training pipeline.
...
\begin{figure}[h]
	...
	\fbox{\begin{minipage}{0.8\textwidth}
			...
			\textit{• Comparison of GRPO vs.
				PPO training stability}\\ \textit{• Standard deviation bands showing training consistency}\\ \textit{• Phase markers for initial, intermediate, and convergence phases}\\ \vspace{3cm} \end{minipage}} \caption{Training dynamics showing the evolution of reward and success rate throughout GRPO training for both 8B and 32B parameter Qwen models using the nano-agent.
...
\begin{figure}[h]
	...
	\fbox{\begin{minipage}{0.8\textwidth}
			...
			\textit{• Comparison between base models, \ac{SFT}, and \ac{RL} training}\\
			...
			\vspace{3cm}
		\end{minipage}}
	\caption{Performance comparison on SWE-Bench-Verified showing statistically significant improvements from online RL training over both pretrained models and supervised fine-tuning approaches.
