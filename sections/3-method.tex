...
Experimental results addressing the research questions are presented in \Cref{ch:results}.
...
Due to the sparsity of instruction-driven multilingual data, an additional 50 multilingual instances were held out for potential test-verified evaluation, though time constraints limited the scope to only reward-based analysis presented in \cref{sec:rq3-swebench}.
