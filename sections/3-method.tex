...
This \ac{MDP} formulation enables direct application of \ac{GRPO}.
\ac{GRPO}~\cite{shao2024deepseekmathpushinglimitsmathematical} operates on batches of trajectories $\{\tau_1, \tau_2, \ldots, \tau_B\}$, computing advantages by comparing terminal rewards within each batch.
