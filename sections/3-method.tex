...
% We retain the same outcome-driven similarity principle as SWE-RL~\cite{wei2025swerladvancingllmreasoning} while embedding it within an interactive, multi-step setting that rewards successful end-to-end repair after autonomous context acquisition.
