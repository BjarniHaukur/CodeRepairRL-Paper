...
While existing implementations of \ac{GRPO} existed in the TRL library \cite{trl2020}, they were not designed for the complex interaction patterns required by coding agents.
