...
The \ac{GSPO} loss involves multiple sequential operations: log-probability computation, dual masking, importance weighting, advantage normalization, and clipping.
