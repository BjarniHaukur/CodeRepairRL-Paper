...
Tertiary metrics quantify cross-scaffold transfer: we replay checkpoints on Mini-SWE-Agent-, Aider-, and OpenHands-style harnesses to measure zero-shot and few-shot generalization using the protocol shared with the accompanying conference draft.\todoinline{Confirm final harness list and evaluation attempt budgets.}
