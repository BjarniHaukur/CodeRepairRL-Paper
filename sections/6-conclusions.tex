...
\textbf{\ac{GRPO}
Optimization for Agents}: We adapt Group Relative Policy Optimization~\cite{grpo2024} for coding agents, demonstrating its suitability as an alternative to traditional actor-critic methods while reducing computational overhead through elimination of value network training.
