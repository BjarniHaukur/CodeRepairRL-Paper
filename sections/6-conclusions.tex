...
\textbf{Findings}: Training demonstrates sustained reward progression throughout, with mean patch-similarity rewards approximately doubling from 0.05 to 0.10.
...
Transient declines around steps 200 and 500 reflect characteristic online learning dynamics where overreinforced patterns degrade performance before superior alternatives emerge.
...
\label{subsec:ethics-sustainability}
...
Episodes execute with some restrictive measures to prevent host system compromise, though future work should explore stronger containerization for enhanced security.

The low-resource optimizations detailed in Chapter~\ref{ch:method} align naturally with reduced energy consumption.
