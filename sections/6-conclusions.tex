...
\subsection{RQ1: Effectiveness of Interactive RL}

\textbf{Finding}: Interactive reinforcement learning produces substantial and statistically significant improvements over both pretrained models and supervised fine-tuning approaches.
...
\textbf{Finding}: Debugging capabilities learned through interactive RL demonstrate positive transfer across multiple dimensions, indicating acquisition of fundamental rather than narrow skills.
