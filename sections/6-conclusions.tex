...
\textbf{Finding}: Models trained on SWE-Gym predictably improve on \ac{SWE-Bench} but they also generalize to Multi-SWE-Bench without signs of severe overfitting. \todoinline{Add actual results here}
