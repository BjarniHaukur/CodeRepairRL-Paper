...
\subsection{RQ1: Nano Agent Scaffold Adaptation} \label{subsec:rq1-answer}

\textbf{Research Question}: How does \ac{GSPO} training improve Nano agent scaffold adaptation?
...
\textbf{Implications}: Policy gradient optimization successfully reinforces effective tool-usage patterns within the single-agent paradigm, demonstrating co-adaptation between model and scaffold through environmental interaction.
...
\textbf{Findings}: Training dramatically improves scaffold adaptation—patch completion rates more than double from 37\% to 78\% and patch-similarity rewards increase by 54\%—but test-verified success remains flat at approximately 6--7\%.
...
This work demonstrates that online \ac{RL} training for coding agents is practically feasible within academic compute constraints and yields measurable improvements in scaffold adaptation.
