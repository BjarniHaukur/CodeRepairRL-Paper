...
\textbf{\ac{GSPO} Optimization for Agents}: We adapt \ac{GSPO}~\cite{gspo2025} with KL regularization for coding agents, demonstrating its suitability as an alternative to traditional actor-critic methods while reducing computational overhead through elimination of value network training and stabilizing small-batch updates.\todoinline{Ensure GSPO reference is included in the bibliography.}
