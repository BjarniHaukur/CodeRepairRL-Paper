...
This thesis presents the first comprehensive open-source implementation of online \ac{RL} for automated code repair, demonstrating significant advances in both theoretical understanding and practical capabilities.
Through rigorous experimental validation, we establish this paradigm as a viable and superior alternative to traditional supervised learning approaches for training programming agents.
...
\textbf{Open-Source Democratization}: Complete open-source release of training infrastructure, agent implementations, and evaluation protocols reduces barriers to academic research and enables reproducible investigation of online RL techniques previously available only to industry laboratories.
...
\textbf{Significance}: Supports the thesis that experiential training yields broadly applicable debugging skills.
...
Our results support a fundamental shift from static dataset-based training to experiential environment-based learning for complex reasoning tasks.
The success of online \ac{RL} suggests that many \ac{AI} capabilities may be better acquired through direct interaction rather than passive observation, particularly for domains requiring multi-step reasoning and strategic planning.
...
By providing complete open-source implementations, we enable broader academic investigation of online RL techniques and reduce dependence on proprietary industry research.
...
\subsection{Validation of Fundamental \ac{AI}
	Principles}
...
Effective online reinforcement learning on coding agents represents a crucial step by demonstrating that experiential learning can develop sophisticated reasoning capabilities.
...
While significant challenges remain, the clear evidence of improvement through experiential learning suggests that this paradigm will play an increasingly important role in developing \ac{AI} systems capable of genuine reasoning and problem-solving.
