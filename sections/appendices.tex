...
\todoinline{Fill in sampling parameters table.
All parameters are identical across models except time limit.
Include specific values for temperature (e.g., 0.7-1.0), top-k, top-p, min-p, token limit, tool limit, and model-specific time limits.
}

\section{\ac{LoRA} Configuration}
