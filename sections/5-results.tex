...
\todoinline{Insert Figure showing evolution of reward and success rate throughout training for both 8B and 32B parameter Qwen models using the Nano agent.}
...
\begin{itemize}
\item Plots showing tool success rate vs training steps
\item Invalid call rate evolution over training
