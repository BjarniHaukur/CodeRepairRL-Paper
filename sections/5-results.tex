...
This chapter presents comprehensive experimental results addressing our research questions (RQ1/RQ2/RQ3/RQ4) about online \ac{RL} for automated code repair.
...
The learning curves demonstrate monotonic improvement throughout training, validating our hypothesis that online \ac{RL} can successfully enhance coding capabilities through environmental interaction.
...
Table~\ref{tab:main-results} presents our primary experimental results on \ac{SWE-Bench-Verified}, comparing online \ac{RL} training against multiple baseline approaches.
...
These results provide strong evidence that online \ac{RL} produces substantial and statistically significant improvements over pre-trained models
...
\textbf{Multi-step Interaction (12.7\% impact)}: The ability to perform multiple actions per bug fix is the most important factor, validating our core hypothesis about experiential learning.
...
The computational costs of online training compare favorably to alternative approaches:
