...
This chapter presents experimental results addressing the three research questions established in \Cref{ch:introduction}.
...
\emph{However}, test-verified success decreases from 36 to 31 resolved instances (7.2\% $\to$ 6.2\%).
