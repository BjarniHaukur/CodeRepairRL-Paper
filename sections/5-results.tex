...
\textbf{RQ1 (Interactive RL Effectiveness)}: Interactive RL produces statistically significant improvements (7-10 percentage points) over both pretrained models and supervised fine-tuning, validating the core hypothesis.
