...
This chapter presents comprehensive experimental results addressing our research questions (RQ1/RQ2/RQ3/RQ4) about interactive reinforcement learning for automated code repair. We demonstrate statistically significant improvements over baseline approaches and evaluate the generalization of learned debugging capabilities.
...
\section{Main Results: Interactive RL vs. Baselines}
...
\end{itemize}
\todoinline{Insert plots: tool success vs steps, invalid call rate vs steps, actions-per-episode distribution. Add numbers from logs.}
...
\todoinline{Add table comparing Qwen vs SmolLM3 (or chosen models) on SWE-Bench-Verified, with same budgets and prompts. Include tool success metrics.}

\section{RQ3: SWE-Gym Training vs. SWE-Bench/Multi-SWE-Bench Evaluation}
...
\todoinline{Add cross-dataset results, gap analysis vs. SFT, and discussion of overfitting indicators.}
...
\textbf{RQ1 (Harness Adaptation)}: RL training improves adaptation to the nano harness, increasing tool success and reducing invalid calls, with improved action efficiency. \todoinline{Cite Sec.~\ref{sec:rq1-harness} and insert concrete deltas.}
