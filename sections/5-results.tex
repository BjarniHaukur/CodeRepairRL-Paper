...
This chapter presents comprehensive experimental results addressing our research questions (RQ1/RQ2/RQ3/RQ4) about interactive reinforcement learning for automated code repair.
...
Our GRPO training demonstrates clear and consistent learning dynamics across multiple experimental runs.
...
The learning curves demonstrate monotonic improvement throughout training, validating our hypothesis that interactive RL can successfully enhance coding capabilities through environmental interaction.

\subsubsection{Training Stability}

GRPO training exhibits remarkable stability compared to traditional PPO implementations.
...
\todoinline{Add cross-dataset results, gap analysis vs.
	SFT, and discussion of overfitting indicators.
}
...
\textbf{GRPO vs.
	PPO (5.5\% impact)}: GRPO's group-relative advantages provide meaningful improvements over traditional actor-critic methods.
...
Performance improves with larger batches up to 32 trajectories, then plateaus, indicating optimal reward signal averaging for GRPO.
