...
Instead it receives static, repository-local feedback (e.g., patch similarity and other non-executed diagnostics) that is sparse and delayed at the episode level.
...
Tool-using coding agents already exist; what is largely missing in the open scientific community is an open, reproducible training pipeline for such agents.
