...
\begin{itemize}
	...
	\item This approach tests whether our findings are Qwen-specific or represent broader principles for interactive \ac{RL} training.
\end{itemize}
...
We deliberately avoud reasoning models as they generate excessively verbose outputs that rapidly exhaust token budgets in our interactive training environment.
...
\textbf{Methodological Boundaries}: We briefly explored distillation via \ac{SFT}, but did not pursue it further due to limited empirical benefit and because reliance on proprietary teacher models would run counter to the thesis objective of advancing open RL training for agentic coding behaviour.
