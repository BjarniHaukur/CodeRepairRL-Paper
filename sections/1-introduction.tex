...
\textbf{Chapter 5: Results} presents experimental findings: training convergence and policy gradient signal stability (RQ0), harness adaptation metrics and behavioral changes (RQ1), performance comparisons on SWE-Bench-Verified (RQ2), and language-agnostic training effectiveness on the multilingual held-out subset (RQ3).
