...
We introduce a \ac{RL} approach that trains the \ac{LLM} within its deployment scaffold, enabling the model to learn tool usage through environmental interaction rather than mere pattern matching.
...
Training on a 1{,}000-task curriculum over 144 \ac{GPU}-hours across 2 days on 3 A100s, tractable within typical academic allocations, demonstrates measurable improvements in scaffold adaptation and patch-similarity rewards.
