...
% Detail/Nuance
We implement this through a two-stage pipeline combining \ac{SFT} with Group Relative Policy Optimization (\ac{GRPO}), where models actively debug real repositories during training.
