% Language settings must come before biblatex
...
% Improve word spacing and justification with microtype
...
% Define a subtle background color for code
\definecolor{codebg}{RGB}{248,248,250}

% Configure minted style
\setminted{
bgcolor=codebg,
fontsize=\small,
linenos=false,
...
\usepackage{acro}
\acsetup{list/display=used,make-links=true}
\input{setup/acronyms}

\usepackage{todonotes}
\newcommand{\todoinline}[1]{%
\leavevmode\noindent%
\colorbox{yellow!30}{\parbox{\dimexpr\linewidth-2\fboxsep}{\textbf{TODO:} #1}}%
}
...
% Balanced hyphenation settings - avoid excessive hyphenation and spacing
\pretolerance=1000
\tolerance=1500
\hyphenpenalty=5000
